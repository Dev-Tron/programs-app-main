  ...
  <div>
    <div className='p-4 md:p-6 mt-2 md:mt-3 lg:mt-8'>
        <div className='flex gap-4'>
            ...
            <input className='bg-transparent w-9/12 md:text-2xl focus:border-b-2 outline-0 focus:border-light-grey pb-3 w-full caret-dark-red' type='text' placeholder='Search for movies' onChange={event => {setSearchProgram(event.target.value)}}/>
        </div>
        <section>
            <div className='mt-5 md:mt-10'>
                <h1 className='text-xl md:text-2.5xl text-white'>Movies</h1>
                            ...
                            <div className='mt-4 relative group'>
                                ...
                                <div className='mt-2'>
                                    <div className='flex text-xs md:text-base gap-2'>
                                        <p>{program.year}</p>
                                        <span>&#8226;</span>
                                        <Image className='md:w-5 md:h-5' src="/images/icon-category-movie.svg" alt='movie' width={20} height={20}/>
